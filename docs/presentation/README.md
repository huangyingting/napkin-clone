...
| [semantic-slide-design-system.md](semantic-slide-design-system.md)         | Proposed full refactor for the semantic slide schema, theme style system, AI generation, editor, and export. |
