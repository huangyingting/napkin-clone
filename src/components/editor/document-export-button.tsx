    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && !isExporting ? (
        <div
          role="menu"
          aria-label="Export document"
          className="absolute right-0 top-full z-20 mt-1 min-w-[240px] overflow-hidden rounded-ds-lg border border-ds-border-subtle bg-ds-surface-raised shadow-ds-overlay"
          onBlur={(e) => {
