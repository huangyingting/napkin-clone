...
// ---------------------------------------------------------------------------
// Theme configuration (presentation canvas accents — distinct from app chrome)
// ---------------------------------------------------------------------------

type ThemeConfig = {
  /** CSS color for accent headings / bullets / hr. */
  accentColor: string;
  /** CSS background for the slide canvas. */
  bgColor: string;
  /** CSS color for primary title text. */
  titleColor: string;
  /** CSS color for body text. */
  bodyColor: string;
  /** CSS color for muted text (section label, bullets). */
  mutedColor: string;
};
