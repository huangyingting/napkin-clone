...
function blankFlowchart(): Visual {
  return {
    ...
    style: { ...DEFAULT_STYLE },
    nodes: [
      { id: "n1", label: "Start", x: 240, y: 70, width: 150, height: 56, shape: "rounded" },
      { id: "n2", label: "Step", x: 240, y: 190, width: 150, height: 56, shape: "rounded" },
      { id: "n3", label: "End", x: 240, y: 310, width: 150, height: 56, shape: "rounded" },
    ],
    edges: [
      { id: "e1", from: "n1", to: "n2" },
      { id: "e2", from: "n2", to: "n3" },
...
function blankMindmap(): Visual {
  return {
    ...
    style: { ...DEFAULT_STYLE },
    nodes: [
      { id: "root", label: "Central idea", x: 300, y: 180, width: 180, height: 60, shape: "pill" },
      { id: "b1", label: "Branch 1", x: 110, y: 90, width: 130, height: 48, shape: "pill" },
      { id: "b2", label: "Branch 2", x: 490, y: 90, width: 130, height: 48, shape: "pill" },
      { id: "b3", label: "Branch 3", x: 110, y: 270, width: 130, height: 48, shape: "pill" },
      { id: "b4", label: "Branch 4", x: 490, y: 270, width: 130, height: 48, shape: "pill" },
    ],
    edges: [
...
function blankConcept(): Visual {
  return {
    ...
    style: { ...DEFAULT_STYLE },
    nodes: [
      { id: "c1", label: "Concept", x: 300, y: 90, width: 160, height: 60, shape: "ellipse" },
      { id: "c2", label: "Idea A", x: 140, y: 290, width: 150, height: 60, shape: "ellipse" },
      { id: "c3", label: "Idea B", x: 460, y: 290, width: 150, height: 60, shape: "ellipse" },
    ],
    edges: [
