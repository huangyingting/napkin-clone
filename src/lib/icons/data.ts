/**
 * Static icon catalog data and curated defaults.
 *
 * Keep this file data-only: no network, dynamic imports, or search/scoring logic.
 */
...
export const DEFAULT_ICON_NAMES: readonly string[] = [
  "Lightbulb",
  "Target",
  "Rocket",
  "Users",
