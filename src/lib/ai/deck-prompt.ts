...
const SYSTEM_PROMPT = [
  ...
  "- Do not author decorative shape/image styling in this generic response. Choose the best `templateId` and theme; theme-package templates own decorative shapes, image masks, radial fills, and glass effects.",
