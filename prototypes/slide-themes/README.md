...
- `render-family-layouts.ts` — distinct per-render-family layouts (gradients,
  shapes, font pairing) so each of the 43 semantic templates looks bespoke.
...
| --- | ------------- | ------------------------- | ------------------------------ | --------- | ------------------------------------------------------------- |
| 1   | **Clarity**   | Business decisions        | Inter / Source Sans 3          | `#2563eb` | Side panel, accent rules, crisp metric bars                   |
| 2   | **Ocean**     | Product / data review     | Space Grotesk / Inter          | `#0284c7` | Layered current orbs, depth fields, soft cards                |
| 3   | **Aurora**    | Tech / SaaS keynote       | Space Grotesk / Inter          | `#6366f1` | Soft gradient glow ellipses, accent spine bars, rounded cards |
| 4   | **Monolith**  | Corporate / consulting    | IBM Plex Sans                  | `#b3892f` | Navy sidebar, gold rules & ticks, zero-radius panels          |
| 5   | **Editorial** | Magazine / brand story    | Source Serif 4 / Source Sans 3 | `#e0533b` | Hairline frame, oversized quote marks, coral underlines       |
| 6   | **Noir**      | Premium pitch deck        | Manrope / Inter                | `#f5b301` | Amber glow ellipses, dot rows, dark cards                     |
| 7   | **Terra**     | Sustainability / research | Manrope / Source Sans 3        | `#c2683f` | Organic leaf ellipses, deep-radius cards, forest fields       |
| 8   | **Pulse**     | Bold startup / marketing  | Space Grotesk / Manrope        | `#ec2d6f` | Diagonal triangle wedges, orbs, hot gradients                 |
